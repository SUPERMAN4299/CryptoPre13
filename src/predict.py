...
# MODEL PATHS
# ------------------------------
MODEL_PATH = "F:/TradeAI (dream)/models/universal_signal_model.xgb"
SCALER_PATH = "F:/TradeAI (dream)/models/universal_scaler.pkl"
FEATURE_PATH = "F:/TradeAI (dream)/models/feature_names.json"
